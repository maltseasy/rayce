/*
Notes
- Arduino uno has 2k of SRAM, 1k of EEPROM
- Mega has 8k SRAM, 4k EEPROM
- Arduino sends data to host PC
- Python runs Tkinter GUI
- IV_Swinger2 module (python) provides an API for controlling IV swinger hardware
- performs handshakes with host through python module
- use Iv swinger 2 sim code to simulate component values
*/
